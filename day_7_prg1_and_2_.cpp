...
A random sample of 20 nominally measured 2mm diameter steel ball bearings is taken and the diameters are measured precisely. 
...
Measurements are made on the lengths, in mm, of a sample of twenty wooden components for self-assembly furniture. 
Assume that these may be regarded as twenty independent observations from a normal distribution with unknown mean µ and unknown variance σ². 
